...
# Evaluation
  ## Installation
  - Because of the existence of large file stored using Git Large File Storage (GLFS), we need first to install LFS package       before cloning the project. For example for Linux based system :
    ```sh
