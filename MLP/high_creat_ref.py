...
dataset = pd.read_csv('metagenomics_signatures_1-8_CAMI_HIGH_mean.csv')
#dataset = pd.read_csv('/bettik/matouguib/cami/fasta/results/metagenomics_signatures_1-8_CAMI_MED_mean/metagenomics_signatures_1-8_CAMI_MED_mean_1123232.csv')
...
print(len(y))
fileoutput = open('reference_high.txt','w+')
