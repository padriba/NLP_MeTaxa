...
dataset = pd.read_csv('NLP/vectorisation_results/medium/metagenomicreadsigntaures_8_mers.csv')
...
json_file = open('CNN/medium_cnn_template.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(loaded_model_json)
# load weights into new model
loaded_model.load_weights("CNN/medium_cnn_template.h5")
...
df = pd.read_csv('NLP/vectorisation_results/medium/metagenomicreadsigntaures_8_mers.csv', header=None)
...
fileoutput = open('CNN/Metrics_By_Rank/results/medium/cnn_prediction.txt','w+')
